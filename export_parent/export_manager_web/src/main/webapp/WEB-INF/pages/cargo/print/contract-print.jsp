    ...
    <div class="box box-primary" style="height: 200px;">
        ...
        <form role="form" action="/cargo/contract/printExcel.do">
            <div class="input-group input-group-sm" >
                ...
                <span class="input-group-btn">
                    <button type="submit"   class="btn btn-info btn-flat">打印</button>
                </span>
            </div>
        </form>
        ...
        <form role="form" action="/cargo/contract/printExcelWithTemplate.do">
            <div class="input-group input-group-sm" >
                ...
                <span class="input-group-btn">
                    <button type="submit"   class="btn btn-info btn-flat">模板打印</button>
                </span>
            </div>
        </form>

        <form role="form" action="/cargo/contract/printExcelWithMillion.do">
            <div class="input-group input-group-sm" >
                <div class="input-group-addon">
                    <i class="fa fa-calendar"></i>
                </div>
                ...
                <span class="input-group-btn">
                    <button type="submit"   class="btn btn-info btn-flat">百万数据打印</button>
                </span>
            </div>
        </form>
    </div>
